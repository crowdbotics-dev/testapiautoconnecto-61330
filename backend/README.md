...
## Project Structure
    ...
    ├── testapiautoconnecto_61330  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_61330`
...
2. Clone this repo and `cd testapiautoconnecto_61330`
